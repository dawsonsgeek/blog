...
<?php include_once('./social-media-icons.php')?>
                ...
                <div class="dawsonsgeek-page-title">
                    ...
                    <div class="dawsonsgeek-page-title-meta">
                        <div class="dawsonsgeek-author-meta">
                            By <a class="author-meta" href="author.html">Dawson Richey</a>
                        </div>
                        <div class="dawsonsgeek-cat-meta">
                            In <a href="category.html">Lifestyle</a>
                        </div>
                        <div class="dawsonsgeek-date-meta">May 25, 2018</div>
                        <div class="dawsonsgeek-reading-meta">3 min read</div>
                    </div>
                </div>
                <!-- FEATURED IMAGE -->
                <div class="dawsonsgeek-featured-img">
                    <img src="images/1200x600.png" alt="" />
                </div>
                <!-- POST CONTENT -->
                <div class="dawsonsgeek-page-content">
                    ...
                    <div class="clearfix"></div>
                    <!-- TAGS -->
                    <div class="dawsonsgeek-meta-tags">
                    ...
                    <!-- POST NAVIGATION -->
                    <div class="dawsonsgeek-post-nav-wrapper">
                        <!-- PREVIOUS POST -->
                ...
                <div class="clearfix"></div>
                <!-- COMMENTS -->
                <!-- <div id="dawsonsgeek-comments-wrapper">
                    <div id="dawsonsgeek_comments_block" class="dawsonsgeek_comments_block">
                        <h3 class="dawsonsgeek-title-with-border">
                            <span>Comments</span>
                        </h3>
                        <div class="dawsonsgeek_commentlist">
                            <div class="dawsonsgeek_comment_wrapper">
                                <div class="dawsonsgeek_comments">
                                    <div class="dawsonsgeek_comment">
                                        <div class="dawsonsgeek_comment_inner">
                                            <div class="dawsonsgeek_comment_left">
                                                <img alt='' src='images/100x100.png' />
                                            </div>
                                            <div class="dawsonsgeek_comment_right">
                                                <div class="dawsonsgeek_comment_right_inner ">
                                                    <cite class="dawsonsgeek_fn">
                                                        <a href='author.html'>Dawson Richey</a>
                                                    </cite>
                                                    <div class="dawsonsgeek_comment_links">
                                                        <i class="fa fa-clock-o"></i> May 23, 2018 at 9:57 pm - <a href="#">Reply</a>
                                                    </div>
                                                    <div class="dawsonsgeek_comment_text">
